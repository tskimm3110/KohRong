...
const translations = {
  km: {
    ...
    'hero.description': 'ស្វែងយល់អំពីកោះដ៏ស្រស់ស្អាតនេះ តាមរយៈព័ត៌មានពិតប្រាកដពីប្រជាពលរដ្ឋនៅលើកោះ។ រកឃើញកន្លែងដែលស្រស់ស្អាតបំផុង និងបទពិសោធន៍មិនអាចបំភ្លេចបាន។',
    ...
    'newsletter.disclaimer': 'ចូលរួមជាមួយអ្នកទេសចរណ៍ជាង ៥,០០០ នាក់ដែលទុកចិត្តលើយើង។ អាចលុបចេញបានគ្រប់ពេល។',
    'newsletter.subscribers': 'អ្នកតាមដាន',
    'newsletter.rating': 'ការវាយតម្លៃ',
    
    // Footer
    'footer.description': 'ព័ត៌មានពិតប្រាកដអំពីកោះរ៉ុង កម្ពុជា ពីប្រជាពលរដ្ឋនៅលើកោះ។',
  ...
  en: {
    ...
    'hero.description': 'Discover this beautiful island through authentic information from island residents. Find the most beautiful places and unforgettable experiences.',
    ...
    'featured.subtitle': 'Latest stories and information from Koh Rong Cambodia',
    ...
    'newsletter.subtitle': 'Subscribe to receive the latest news about Koh Rong Cambodia',
    'newsletter.placeholder': 'Enter your email address',
    'newsletter.subscribe': 'Subscribe',
    'newsletter.success': 'Successfully subscribed!',
    'newsletter.disclaimer': 'Join over 5,000 travelers who trust us. Unsubscribe anytime.',
    'newsletter.subscribers': 'Subscribers',
    'newsletter.rating': 'Rating',
    
    // Footer
    'footer.description': 'Authentic information about Koh Rong Cambodia from island residents.',
