...
const AccommodationPage: React.FC<AccommodationPageProps> = ({ onBack }) => {
  ...
  const accommodations: Accommodation[] = [
    ...
    },
    {
      ...
      reviews: 150,
      description:
        "រីសតបែបឋានសួគ៌នៅឆ្នេរឡុងសិត ជាមួយនឹងបឹងហ្គាឡូឈើប្រណីត។ បរិយាកាសស្ងប់ស្ងាត់ និងធម្មជាតិស្រស់បំព្រង។",
      descriptionEn:
        "A paradise-like resort on Long Set Beach with luxurious wooden bungalows. Quiet atmosphere and beautiful nature.",
      features: [
        "បឹងហ្គាឡូឈើ",
        "ភោជនីយដ្ឋាន",
        "ស្ប៉ា",
      ...
      coordinates: { lat: 10.605, lng: 103.278 },
      availability: true,
    },
  ];
