...
const ServicesPage: React.FC<ServicesPageProps> = ({
  ...
  const categories = [
    {
      id: "all",
      name: language === "km" ? "សេវាកម្មទាំងអស់" : "All Services",
      icon: ShoppingBag,
    },
    {
      id: "motorbike",
      name: language === "km" ? "ជួលម៉ូតូ" : "Motorbike Rental",
      icon: Bike,
    },
    { id: "car", name: language === "km" ? "ជួលឡាន" : "Car Rental", icon: Car },
    {
      id: "taxi",
      name: language === "km" ? "តាក់ស៊ី" : "Taxi Service",
      icon: Navigation,
    },
    {
      id: "boat",
      name: language === "km" ? "សេវាកម្មទូក" : "Boat Services",
      icon: Anchor,
    },
    {
      id: "watersports",
      name: language === "km" ? "កីឡាទឹក" : "Water Sports",
      icon: Waves,
    },
    {
      id: "tickets",
      name: language === "km" ? "កក់សំបុត្រ" : "Ticket Booking",
      icon: Ticket,
    },
  ];
  ...
  const services: Service[] = [
    {
      ...
      description:
        "ម៉ូតូស្ថានភាពល្អសម្រាប់ដើរលេងកោះរ៉ុង។ មានសុវត្ថិភាពខ្ពស់ និងសន្សំប្រេង។ ល្អសម្រាប់ការធ្វើដំណើរជុំវិញកោះ។",
      descriptionEn:
        "Good condition motorbikes for exploring Koh Rong. High safety and fuel efficient. Perfect for traveling around the island.",
      price: "$10-15",
      priceEn: "$10-15",
    ...
    },
    {
      ...
      description:
        "សេវាកម្មតាក់ស៊ីជាមួយអ្នកបើកបរមានបទពិសោធន៍។ ទៅតាមទីតាំងផ្សេងៗនៅកោះរ៉ុង និងព្រះសីហនុ។",
      descriptionEn:
        "Taxi service with experienced drivers. Go to various locations on Koh Rong and Sihanoukville.",
      price: "$10-40",
      priceEn: "$10-40",
    ...
    },
    {
      ...
      description:
        "សេវាកម្មតាក់ស៊ីទូកឯកជនទៅកាន់ឆ្នេរផ្សេងៗនៅកោះរ៉ុង។ រហ័ស សុវត្ថិភាព និងសេវាកម្មល្អ។",
      descriptionEn:
        "Private boat taxi service to various beaches on Koh Rong. Fast, safe, and good service.",
      price: "$40-150",
      priceEn: "$40-150",
      duration: "ទៅតាមទីតាំង",
      durationEn: "By destination",
    ...
    },
    {
      ...
      description:
        "ឡានឯកជនជាមួយអ្នកបើកបរមានបទពិសោធន៍។ ល្អសម្រាប់ការធ្វើដំណើរពីព្រះសីហនុមកកោះរ៉ុង និងទីកន្លែងផ្សេងៗ។",
      descriptionEn:
        "Private car with experienced driver. Perfect for travel from Sihanoukville to Koh Rong and other places.",
      price: "$40-80",
      priceEn: "$40-80",
      duration: "ក្នុងមួយថ្ងៃ",
      durationEn: "Per day",
    ...
    },
    {
      ...
      description:
        "ម៉ូតូទឹកទំនើបសម្រាប់បទពិសោធន៍រំភើបនៅលើទឹកសមុទ្រ។ មានការណែនាំសុវត្ថិភាព និងឧបករណ៍ការពារ។",
      descriptionEn:
        "Modern jet skis for exciting experience on the ocean. Safety instruction and protective equipment included.",
      price: "$80-150",
      priceEn: "$80-150",
    ...
    },
    {
      ...
      categoryEn: "Motorbike Rental",
      description:
        "ម៉ូតូកង់បួនសម្រាប់ការផ្សងព្រេងនៅលើដីនិងឆ្នេរ។ បទពិសោធន៍រំភើប និងសុវត្ថិភាពខ្ពស់។",
      descriptionEn:
        "ATV for adventure on land and beach. Exciting experience and high safety.",
      price: "$40-80",
      priceEn: "$40-80",
      duration: "ក្នុងមួយម៉ោង",
      durationEn: "Per hour",
    ...
    },
    {
      ...
      categoryEn: "Boat Services",
      description:
        "ទូកទេសចរណ៍ និងស្ទូចត្រីឯកជនជាមួយឧបករណ៍ពេញលេញ។ ល្អសម្រាប់ការទេសចរណ៍ និងស្ទូចត្រី។",
      descriptionEn:
        "Private tourism and fishing boat with complete equipment. Perfect for sightseeing and fishing.",
      price: "$80-300",
      priceEn: "$80-300",
      duration: "ក្នុងមួយថ្ងៃ",
      durationEn: "Per day",
    ...
    },
    {
      ...
      categoryEn: "Boat Services",
      description:
        "សេវាកម្មអូបរទូកល្បឿនលឿនឯកជន។ ការធ្វើដំណើររហ័ស និងសុវត្ថិភាពពីព្រះសីហនុទៅកោះរ៉ុង។",
      descriptionEn:
        "Private speed boat operator service. Fast and safe travel from Sihanoukville to Koh Rong.",
      price: "$600-1500",
      priceEn: "$600-1500",
      duration: "ក្នុងមួយថ្ងៃ",
      durationEn: "Per day",
    ...
    },
    {
      ...
      description:
        "សេវាកម្មកក់សំបុត្រទូកល្បឿនលឿនអនឡាញ។ ងាយស្រួល រហ័ស និងមានការធានា។",
      descriptionEn:
        "Online speed boat ticket booking service. Easy, fast, and guaranteed.",
    ...
    },
    {
      ...
      categoryEn: "Ticket Booking",
      description:
        "សេវាកម្មកក់សំបុត្រឡានក្រុងពីព្រះសីហនុទៅភ្នំពេញ។ ឡានទំនើប និងសុវត្ថិភាពខ្ពស់។",
      descriptionEn:
        "Bus ticket booking service from Sihanoukville to Phnom Penh. Modern buses and high safety.",
      price: "$14.5-20",
      priceEn: "$14.5-20",
      duration: "៤-៥ ម៉ោង",
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    ...
    setSelectedCategory("all"); // Optional: Reset category when searching
  };

  // Filter services based on the submitted search term and category
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20  overflow-hidden">
        <div className="absolute inset-0 opacity-100">
          <img
            src="https://www.travelwithanda.com/wp-content/uploads/2019/02/from-sihanoukville-to-koh-rong-sanloem-blog-travel-tips.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <input
              ...
              placeholder={
                language === "km" ? "ស្វែងរកសេវាកម្ម..." : "Search services..."
              }
              className="w-full pr-28 pl-4 py-4 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-koh-rong-500 focus:border-transparent transition-all text-lg"
            />
            <button
              type="submit"
              className="absolute right-2 top-1/2 transform -translate-y-1/2 h-10 px-4 bg-koh-rong-500 text-white rounded-xl font-semibold hover:bg-koh-rong-600 transition-colors flex items-center"
            >
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    setSubmittedSearchTerm(""); // Clear search when a category is selected
                    setSearchInput("");
                  }}
      ...
      {/* Popular Services */}
      {selectedCategory === "all" && !submittedSearchTerm && (
          ...
          <div className="mb-8">
            ...
            {submittedSearchTerm && (
              <p className="text-gray-600">
                {language === "km"
                  ? `លទ្ធផលសម្រាប់ "${submittedSearchTerm}"`
                  : `Results for "${submittedSearchTerm}"`}
              </p>
            )}
          </div>
