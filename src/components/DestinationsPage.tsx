...
const DestinationsPage: React.FC<DestinationsPageProps> = ({
  ...
  const villages = [
    ...
    {
      id: "daem-thkov",
      name: language === "km" ? "ភូមិដើមថ្កូវ" : "Daem Thkov Village",
    },
    {
      id: "prek-svay",
      name: language === "km" ? "ភូមិព្រែកស្វា" : "Prek Svay Village",
    },
    {
      id: "sok-san",
      name: language === "km" ? "ភូមិសុខសាន្ត" : "Sok San Village",
    },
    {
      id: "koh-touch",
      name: language === "km" ? "ភូមិកោះតូច" : "Koh Touch Village",
    },
    {
      id: "koh-rong-sanloem",
      name:
        language === "km" ? "ភូមិកោះរ៉ុងសន្លឹម" : "Koh Rong Sanloem Village",
    },
  ];
  ...
  const villageData: Village[] = [
    {
      ...
      women: 263,
      description:
        "ភូមិកោះតូចគឺជាចំណុចចូលសំខាន់បំផុតនៅកោះរ៉ុង។ ជាកន្លែងដែលមានកំពង់ផែទូកល្បឿនលឿន ភោជនីយដ្ឋាន កន្លែងស្នាក់នៅ និងជីវិតយប់សកម្ម។ ភូមិនេះមានប្រជាពលរដ្ឋ ៥៦៨ នាក់ ក្នុងនោះមានស្រី ២៦៣ នាក់ និងមានគ្រួសារសរុប ១៧១ គ្រួសារ។",
      descriptionEn:
        "Koh Touch Village is the main entry point to Koh Rong. It has the speed boat pier, restaurants, accommodations, and active nightlife. This village has 568 residents, including 263 women, with a total of 171 families.",
      features: [
        "កំពង់ផែទូកល្បឿនលឿន",
        "ភោជនីយដ្ឋានច្រើន",
        "កន្លែងស្នាក់នៅច្រើន",
    ...
    },
    {
      ...
      women: 210,
      description:
        "ភូមិកោះរ៉ុងសន្លឹមស្ថិតនៅលើកោះរ៉ុងសន្លឹម ជាកោះប្អូនរបស់កោះរ៉ុង។ ភូមិនេះមានបរិយាកាសស្ងប់ស្ងាត់ជាងភូមិកោះតូច ហើយមានឆ្នេរស្រស់ស្អាតជាច្រើន។ ភូមិនេះមានប្រជាពលរដ្ឋ ៥១៩ នាក់ ក្នុងនោះមានស្រី ២១០ នាក់ និងមានគ្រួសារសរុប ១៧០ គ្រួសារ។",
      descriptionEn:
        "Koh Rong Sanloem Village is located on Koh Rong Sanloem, the sister island of Koh Rong. This village has a more peaceful atmosphere than Koh Touch and has many beautiful beaches. This village has 519 residents, including 210 women, with a total of 170 families.",
      features: [
        "ស្ងប់ស្ងាត់",
        "ឆ្នេរស្រស់ស្អាត",
        "ភ្លើងសញ្ញាសមុទ្រ",
      ...
      beaches: [
        "ឆ្នេររ៉ុងសន្លឹម",
        "ឆ្នេរថ្មដុះ",
        "ឆ្នេរព្រែកកោងកាងវរៈការពារកោះលេខបួន",
        "ឆ្នេរខ្សាច់ស",
        "ឆ្នេរ២៣",
        "ឆ្នេរថ្ងៃលិច",
        "ឆ្នេរភ្លើងសញ្ញា",
      ...
      beachesEn: [
        "Rong Sanloem Beach",
        "Thom Doh Beach",
        "Prek Kong Kang Protected Island 4 Beach",
        "White Sand Beach",
        "Beach 23",
        "Sunset Beach",
        "Lighthouse Beach",
    ...
    },
    {
      ...
      women: 340,
      description:
        "ភូមិដើមថ្កូវគឺជាភូមិដ៏ធំមួយនៅកោះរ៉ុង ដែលមានឆ្នេរស្រស់ស្អាតជាច្រើន។ ភូមិនេះមានប្រជាពលរដ្ឋ ៦២០ នាក់ ក្នុងនោះមានស្រី ៣៤០ នាក់ និងមានគ្រួសារសរុប ២៧០ គ្រួសារ។ ប្រជាពលរដ្ឋភាគច្រើនប្រកបរបរនេសាទ និងកសិកម្ម។",
      descriptionEn:
        "Daem Thkov Village is a large village on Koh Rong with many beautiful beaches. This village has 620 residents, including 340 women, with a total of 270 families. Most residents work in fishing and agriculture.",
    ...
    },
    {
      ...
      women: 465,
      description:
        "ភូមិព្រែកស្វាយគឺជាភូមិដែលមានប្រជាពលរដ្ឋច្រើនជាងគេនៅកោះរ៉ុង។ ភូមិនេះមានប្រជាពលរដ្ឋ ៧៥០ នាក់ ក្នុងនោះមានស្រី ៤៦៥ នាក់ និងមានគ្រួសារសរុប ២៩០ គ្រួសារ។ ភូមិនេះមានព្រៃកោងកាងដ៏ធំ និងជាកន្លែងល្អសម្រាប់ការស្វែងយល់អំពីធម្មជាតិ។",
      descriptionEn:
        "Prek Svay Village is the most populated village on Koh Rong. This village has 750 residents, including 465 women, with a total of 290 families. This village has a large mangrove forest and is a great place for nature exploration.",
      features: [
        "ព្រៃកោងកាង",
        "ប្រជាពលរដ្ឋច្រើន",
        "ការនេសាទ",
    ...
    },
    {
      ...
      women: 286,
      description:
        "ភូមិសុខសាន្តគឺជាភូមិដែលមានឆ្នេរល្បីបំផុតនៅកោះរ៉ុង។ ភូមិនេះមានប្រជាពលរដ្ឋ ៤៣២ នាក់ ក្នុងនោះមានស្រី ២៨៦ នាក់ និងមានគ្រួសារសរុប ២៥០ គ្រួសារ។ ភូមិនេះមានរីសតប្រណីតនិងសេវាកម្មទេសចរណ៍ពេញលេញ។",
      descriptionEn:
        "Sok San Village is the village with the most famous beach on Koh Rong. This village has 432 residents, including 286 women, with a total of 250 families. This village has luxury resorts and complete tourism services.",
      features: [
        "ឆ្នេរល្បីបំផុត",
        "រីសតប្រណីត",
        "សេវាកម្មពេញលេញ",
  ...
  const beaches: Beach[] = [
    {
      ...
      description:
        "ឆ្នេរកោះរ៉ុងគឺជាឆ្នេរដ៏ស្រស់ស្អាតនិងធំបំផុតមួយនៅលើកោះ។ ខ្សាច់សនិងទឹកថ្លាដូចកញ្ចក់ធ្វើឱ្យកន្លែងនេះក្លាយជាទីកន្លែងល្អបំផុតសម្រាប់ការសម្រាកលំហែកាយ។",
      descriptionEn:
        "Koh Rong Beach is one of the most beautiful and largest beaches on the island. White sand and crystal clear water make this place perfect for relaxation.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរតូចស្ងប់ស្ងាត់ដែលល្អសម្រាប់ការសម្រាកឯកជន។ មានបរិយាកាសរ៉ូមែនទិកនិងទឹកសមុទ្រស្ងប់។",
      descriptionEn:
        "Small quiet beach perfect for private relaxation. Romantic atmosphere and calm sea water.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរដែលមានឈ្មោះតាមផ្កាជាតិកម្ពុជា។ កន្លែងនេះល្អសម្រាប់ការស្វែងយល់អំពីធម្មជាតិនិងសត្វព្រៃ។",
      descriptionEn:
        "Beach named after Cambodia's national flower. Great place for exploring nature and wildlife.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរដែលមានដើមដូងច្រើន។ ទឹកដូងស្រស់និងម្លប់ដើមដូងធ្វើឱ្យកន្លែងនេះក្លាយជាទីកន្លែងសម្រាកដ៏ល្អ។",
      descriptionEn:
        "Beach with many coconut trees. Fresh coconut water and coconut tree shade make this a great resting place.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរដែលល្បីសម្រាប់ការស្ទូចត្រី។ ទឹកសមុទ្រមានត្រីច្រើនប្រភេទនិងជាកន្លែងល្អសម្រាប់ការស្នរកឹល។",
      descriptionEn:
        "Beach famous for fishing. Sea water has many fish species and is great for snorkeling.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរវែងបំផុតនៅភូមិដើមថ្កូវ។ មានទិដ្ឋភាពស្រស់ស្អាតនិងកន្លែងសម្រាប់សកម្មភាពច្រើនប្រភេទ។",
      descriptionEn:
        "Longest beach in Daem Thkov village. Beautiful scenery and place for various activities.",
      features: [
        "ឆ្នេរវែង",
        "ទិដ្ឋភាពស្រស់ស្អាត",
        "សកម្មភាពច្រើន",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរដែលមានទេសភាពដូចប្រាសាទបុរាណ។ ថ្មធម្មជាតិនិងរូបរាងពិសេសធ្វើឱ្យកន្លែងនេះពិសេស។",
      descriptionEn:
        "Beach with landscape like ancient temple. Natural rocks and special formations make this place unique.",
      features: [
        "ថ្មធម្មជាតិ",
        "រូបរាងពិសេស",
        "ទេសភាពស្រស់ស្អាត",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរវែងដែលមានថ្មធំៗនិងទេសភាពដ៏អស្ចារ្យ។ កន្លែងល្អសម្រាប់ការផ្សងព្រេងនិងស្វែងយល់ធម្មជាតិ។",
      descriptionEn:
        "Long beach with large rocks and amazing landscape. Great place for adventure and nature exploration.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរដែលស្ថិតនៅជិតព្រៃកោងកាង។ បរិស្ថានធម្មជាតិនិងសត្វព្រៃធ្វើឱ្យកន្លែងនេះពិសេស។",
      descriptionEn:
        "Beach located near mangrove forest. Natural environment and wildlife make this place special.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរបន្តពីកោងកាងមួយ។ កន្លែងល្អសម្រាប់ការសិក្សាអេកូឡូស៊ីនិងការអប់រំបរិស្ថាន។",
      descriptionEn:
        "Beach continuing from Kong Kang 1. Great place for ecosystem study and environmental education.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរធំនៅភូមិព្រែកស្វាយ។ មានដើមស្វាយច្រើននិងបរិយាកាសស្រស់ស្អាត។",
      descriptionEn:
        "Large beach in Prek Svay village. Many mango trees and beautiful atmosphere.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរនេសាទដែលអ្នកនេសាទមូលដ្ឋានប្រើប្រាស់។ អ្នកអាចមើលការរស់នៅរបស់អ្នកនេសាទនិងទិញត្រីស្រស់។",
      descriptionEn:
        "Fisherman beach used by local fishermen. You can see fishermen's life and buy fresh fish.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរវែងបំផុតនៅកោះរ៉ុង។ កន្លែងល្អសម្រាប់ការដើរលេងវែងនិងរីករាយជាមួយធម្មជាតិ។",
      descriptionEn:
        "Longest beach on Koh Rong. Great place for long walks and enjoying nature.",
      features: [
        "ឆ្នេរវែងបំផុត",
        "ការដើរលេង",
        "ធម្មជាតិស្រស់ស្អាត",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Commune",
      description:
        "ឆ្នេរល្បីបំផុតនៅកោះរ៉ុង។ មានរីសតប្រណីតនិងសេវាកម្មទេសចរណ៍ពេញលេញ។ កន្លែងល្អបំផុតសម្រាប់ការសម្រាកលំហែកាយ។",
      descriptionEn:
        "Most famous beach on Koh Rong. Has luxury resorts and complete tourism services. Best place for vacation.",
    ...
    },
    {
      ...
      description:
        "ឆ្នេរកណ្តាលនៃកោះរ៉ុង។ មានកំពង់ផែទូកល្បឿនលឿននិងជាចំណុចចូលសំខាន់បំផុត។ មានភោជនីយដ្ឋាននិងកន្លែងស្នាក់នៅច្រើន។",
      descriptionEn:
        "Central beach of Koh Rong. Has speed boat pier and is the most important entry point. Many restaurants and accommodations.",
      features: [
        "កំពង់ផែទូក",
        "ចំណុចចូលសំខាន់",
        "ភោជនីយដ្ឋានច្រើន",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលមានខ្សាច់ពណ៌មាសស្រស់ស្អាត។ កន្លែងល្អសម្រាប់ការថតរូបនិងមើលព្រះអាទិត្យលិច។",
      descriptionEn:
        "Beach with beautiful golden sand. Great place for photography and sunset viewing.",
      features: [
        "ខ្សាច់ពណ៌មាស",
        "ថតរូបស្រស់ស្អាត",
        "ព្រះអាទិត្យលិច",
    ...
    // New beaches added
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដ៏ស្រស់ស្អាតនៅកោះរ៉ុងសន្លឹម។ ទឹកសមុទ្រពណ៌ផ្កាឈូកនិងបរិយាកាសស្ងប់ស្ងាត់ធ្វើឱ្យកន្លែងនេះពិសេស។",
      descriptionEn:
        "Beautiful beach on Koh Rong Sanloem. Turquoise sea water and peaceful atmosphere make this place special.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលមានថ្មធម្មជាតិដុះចេញពីដី។ ទេសភាពពិសេសនិងកន្លែងល្អសម្រាប់ការថតរូប។",
      descriptionEn:
        "Beach with natural rocks growing from the ground. Special landscape and great place for photography.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរនៅតំបន់ការពារធម្មជាតិ។ មានព្រៃកោងកាងនិងប្រព័ន្ធអេកូឡូស៊ីដ៏សម្បូរបែប។",
      descriptionEn:
        "Beach in nature protected area. Has mangrove forest and rich ecosystem.",
      features: [
        "តំបន់ការពារ",
        "ព្រៃកោងកាង",
        "ប្រព័ន្ធអេកូឡូស៊ី",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលមានខ្សាច់សដូចព្រិល។ ទឹកសមុទ្រថ្លាពណ៌ផ្កាឈូកនិងបរិយាកាសស្ងប់ស្ងាត់។",
      descriptionEn:
        "Beach with snow-like white sand. Clear turquoise sea water and peaceful atmosphere.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលមានឈ្មោះតាមលេខ។ ឆ្នេរស្ងប់ស្ងាត់និងមិនសូវមានអ្នកទេសចរណ៍។",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលល្បីល្បាញសម្រាប់ការមើលព្រះអាទិត្យលិច។ ទិដ្ឋភាពព្រះអាទិត្យលិចដ៏ស្រស់ស្អាតបំផុត។",
      descriptionEn:
        "Beach famous for sunset viewing. Most beautiful sunset views.",
      features: [
        "ព្រះអាទិត្យលិចស្រស់ស្អាត",
        "ទិដ្ឋភាពល្អ",
        "រ៉ូមែនទិក",
        "ឆ្នេរវែង",
      ],
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរនៅជិតភ្លើងសញ្ញាសមុទ្រ។ ទិដ្ឋភាពល្អពីលើភ្លើងសញ្ញានិងកន្លែងល្អសម្រាប់ថតរូប។",
      descriptionEn:
        "Beach near the lighthouse. Great views from the lighthouse and good place for photography.",
      features: ["ភ្លើងសញ្ញាសមុទ្រ", "ទិដ្ឋភាពល្អ", "ប្រវត្តិសាស្ត្រ", "ថតរូប"],
      featuresEn: ["Lighthouse", "Great views", "History", "Photography"],
      activities: [
        "ឡើងភ្លើងសញ្ញា",
        "ថតរូប",
        "ស្វែងយល់ប្រវត្តិសាស្ត្រ",
        "ហែលទឹក",
      ],
      activitiesEn: [
        "Climbing lighthouse",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរដែលមានត្រីច្រើនប្រភេទ។ កន្លែងល្អសម្រាប់ការស្នរកឹលនិងមើលត្រី។",
      descriptionEn:
        "Beach with many fish species. Great place for snorkeling and fish watching.",
    ...
    },
    {
      ...
      communeEn: "Koh Rong Sanloem Commune",
      description:
        "ឆ្នេរតូចស្ងប់ស្ងាត់សម្រាប់ការសម្រាកលំហែកាយ។ មានម្លប់ធម្មជាតិនិងបរិយាកាសស្ងប់ស្ងាត់។",
      descriptionEn:
        "Small quiet beach for relaxation. Has natural shade and peaceful atmosphere.",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20  overflow-hidden">
        <div className="absolute inset-0 opacity-100">
          <img
            src="https://cdn.audleytravel.com/-/-/79/177183189229111164165047216100079186057249127106.jpg"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            {language === "km"
              ? "ទីកន្លែងទេសចរណ៍កោះរ៉ុង"
              : "Koh Rong Destinations"}
          </h1>
            ...
            >
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  placeholder={
                    language === "km" ? "ស្វែងរកឆ្នេរ..." : "Search beaches..."
                  }
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4">
                      <div className="bg-gray-50 rounded-xl p-3 text-center">
                        <div className="text-lg font-bold text-koh-rong-600">
                          {village.families}
                        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                {showAllBeaches
                  ? language === "km"
                    ? "ឆ្នេរទាំងអស់នៅកោះរ៉ុង"
                    : "All Beaches on Koh Rong"
                  : language === "km"
                  ? "ឆ្នេរផ្សេងទៀត"
                  : "Other Beaches"}
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-12">
              {villageData.map((village) => (
                <div
                  key={`acc-${village.id}`}
                  className="bg-white rounded-3xl shadow-lg overflow-hidden p-8"
                >
                              ...
                              {village.id === 5 && (
                                <>
                                  <li className="flex items-center space-x-2">
                                    <Star className="h-4 w-4 text-yellow-500" />
                                    <span className="text-gray-700">
                                      Sok San Beach Resort Restaurant
                                    </span>
                                  </li>
                                  <li className="flex items-center space-x-2">
                                    <Star className="h-4 w-4 text-yellow-500" />
                              ...
                              {village.id === 4 && (
                                <>
                                  <li className="flex items-center space-x-2">
                                    <Star className="h-4 w-4 text-yellow-500" />
                                    <span className="text-gray-700">
                                      Prek Svay Community Restaurant
                                    </span>
                                  </li>
                                  <li className="flex items-center space-x-2">
                                    <Star className="h-4 w-4 text-yellow-500" />
                                    <span className="text-gray-700">
                                      Mangrove View Dining
                                    </span>
                                  </li>
                                </>
                              )}
      ...
      <section className="py-20 bg-gradient-to-r from-koh-rong-500 to-koh-rong-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <span>
                {language === "km" ? "រកកន្លែងស្នាក់នៅ" : "Find Accommodation"}
              </span>
            </button>
            <button
              onClick={onBack}
